...
export const getArticlePageRecommendationAdapter =
  recommendationAdapter.getSelectors<IStateSchema>(
    (state) =>
...
const articleDetailsPageRecommendationSlice = createSlice({
  ...
  initialState:
    recommendationAdapter.getInitialState<IArticleDetailsRecommendationSchema>({
      isLoading: false,
      error: undefined,
      ids: [],
      entities: {},
...
export const articleDetailsPageRecommendationActions =
  articleDetailsPageRecommendationSlice.actions;

export const articleDetailsPageRecommendationReducer =
  articleDetailsPageRecommendationSlice.reducer;
